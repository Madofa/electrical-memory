  ...
  return (
    <div className="card space-y-5">
      <p className="text-[12px] text-amber-500/70 font-body bg-amber-500/5 border border-amber-500/15 rounded-lg px-3 py-2">
        Ha de ser el <strong>titular del futur contracte de subministrament</strong>. Si ets inquilí amb contracte de lloguer, el contracte ja és el títol habilitant — no cal autorització addicional del propietari.
      </p>
