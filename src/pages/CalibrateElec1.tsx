...
const CALIBRATED: Omit<Marker, 'id' | 'screenX' | 'screenY'>[] = [
  ...
  { name: 'potencia_max',      x: 294,   y: 718.2, page: 2 },
  { name: 'calibre_cgp',       x: 465.3, y: 718.8, page: 2 },
  { name: 'tensio',            x: 137.3, y: 701.5, page: 2 },
  { name: 'iga_igm',           x: 522,   y: 701.5, page: 2 },
  { name: 'num_circuits',      x: 244,   y: 684.2, page: 2 },
  { name: 'seccio_lga',        x: 390,   y: 684.2, page: 2 },
  { name: 'material_conductor',x: 518,   y: 682.8, page: 2 },
  { name: 'ubicacio_comptadors',x: 430,  y: 667.5, page: 2 },
  { name: 'resist_conductors', x: 282,   y: 666.8, page: 2 },
  { name: 'aillament_terra',   x: 286.7, y: 650.2, page: 2 },
  { name: 'resist_terra',      x: 285.3, y: 633.5, page: 2 },
  { name: 'iga',               x: 284.7, y: 616.2, page: 2 },
