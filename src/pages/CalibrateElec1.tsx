...
const CALIBRATED: Omit<Marker, 'id' | 'screenX' | 'screenY'>[] = [
  ...
  { name: 'empresa_tipus_via', x: 86.7,  y: 479.35, page: 1 },
  { name: 'empresa_nom_via',   x: 167.3, y: 479.35, page: 1 },
  { name: 'empresa_numero',    x: 490,   y: 480.3,  page: 1 },
  { name: 'empresa_bloc',      x: 85.3,  y: 444.3,  page: 1 },
  { name: 'empresa_escala',    x: 176.7, y: 444.3,  page: 1 },
  { name: 'empresa_pis',       x: 270,   y: 445,    page: 1 },
  { name: 'empresa_porta',     x: 365.3, y: 445.7,  page: 1 },
  { name: 'empresa_cp',        x: 462,   y: 444.3,  page: 1 },
  { name: 'empresa_poblacio',  x: 84,    y: 407,    page: 1 },
  { name: 'empresa_tel',       x: 299.3, y: 409,    page: 1 },
  { name: 'empresa_correu',    x: 380.7, y: 408.3,  page: 1 },
