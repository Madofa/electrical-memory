...
const CALIBRATED: Omit<Marker, 'id' | 'screenX' | 'screenY'>[] = [
  ...
  { name: 'chk_nova',          x: 92.7,  y: 176.7, page: 1 },
  { name: 'chk_ampliacio',     x: 151.3, y: 177.3, page: 1 },
  { name: 'chk_modificacio',   x: 226,   y: 176.7, page: 1 },
  { name: 'cups',              x: 386.7, y: 176.7, page: 1 },
  { name: 'opt_p1',            x: 92,    y: 100.7, page: 1 },
  { name: 'opt_p2',            x: 172,   y: 100.7, page: 1 },
  { name: 'opt_memoria',       x: 251.3, y: 100,   page: 1 },
