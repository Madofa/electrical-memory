...
const ALL_FIELDS = [
  ...
  { key: 'empresa_numero',    label: 'Empresa – Núm.' },
  { key: 'empresa_bloc',      label: 'Empresa – Bloc' },
  { key: 'empresa_escala',    label: 'Empresa – Escala' },
  { key: 'empresa_pis',       label: 'Empresa – Pis' },
  { key: 'empresa_porta',     label: 'Empresa – Porta' },
  { key: 'empresa_cp',        label: 'Empresa – C.P. (1a casella)' },
  { key: 'empresa_poblacio',  label: 'Empresa – Població' },
  ...
  { key: 'inst_telefon',      label: 'Instal·lació – Telèfon' },
  { key: 'inst_correu',       label: 'Instal·lació – Correu' },
  // Característiques
...
const CALIBRATED: Omit<Marker, 'id' | 'screenX' | 'screenY'>[] = [
  ...
  { name: 'empresa_nif',       x: 488,   y: 532.7, page: 1 },
  { name: 'instalador_nom',    x: 90.7,  y: 494,   page: 1 },
  { name: 'instalador_cat',    x: 374,   y: 494.7, page: 1 },
  { name: 'instalador_dni',    x: 487.3, y: 494,   page: 1 },
  { name: 'empresa_tipus_via', x: 90.8,  y: 456.2, page: 1 },
  { name: 'empresa_nom_via',   x: 179.9, y: 456.2, page: 1 },
  { name: 'empresa_numero',    x: 522.5, y: 457.1, page: 1 },
  { name: 'empresa_bloc',      x: 90.8,  y: 418.1, page: 1 },
  { name: 'empresa_escala',    x: 185.6, y: 418.1, page: 1 },
  { name: 'empresa_pis',       x: 286.9, y: 418.1, page: 1 },
  { name: 'empresa_porta',     x: 388.6, y: 418.1, page: 1 },
  { name: 'empresa_cp',        x: 486.9, y: 415.1, page: 1 },
  { name: 'empresa_poblacio',  x: 90.8,  y: 379.7, page: 1 },
  { name: 'empresa_tel',       x: 318.2, y: 379.7, page: 1 },
  { name: 'empresa_correu',    x: 404.4, y: 379.7, page: 1 },
  { name: 'inst_tipus_via',    x: 90.8,  y: 307.4, page: 1 },
  { name: 'inst_nom_via',      x: 179.9, y: 307.4, page: 1 },
  ...
  { name: 'inst_telefon',      x: 318.2, y: 234,   page: 1 },
  { name: 'inst_correu',       x: 404.4, y: 234,   page: 1 },
  { name: 'chk_nova',          x: 90.1,  y: 173.8, page: 1 },
  { name: 'chk_ampliacio',     x: 149.6, y: 173.8, page: 1 },
  { name: 'chk_modificacio',   x: 224.7, y: 173.8, page: 1 },
  { name: 'cups',              x: 386.7, y: 176.7, page: 1 },
  { name: 'opt_p1',            x: 90.1,  y: 96.9,  page: 1 },
  { name: 'opt_p2',            x: 169.5, y: 96.9,  page: 1 },
  { name: 'opt_memoria',       x: 248.9, y: 96.9,  page: 1 },
  { name: 'us_installacio',    x: 91.3,  y: 67.3,  page: 1 },
  { name: 'potencia_max',      x: 294,   y: 721.86, page: 2 },
  { name: 'calibre_cgp',       x: 465.3, y: 721.86, page: 2 },
  { name: 'tensio',            x: 137.3, y: 704.82, page: 2 },
  { name: 'iga_igm',           x: 522,   y: 704.82, page: 2 },
  { name: 'num_circuits',      x: 244,   y: 688.02, page: 2 },
  { name: 'seccio_lga',        x: 390,   y: 687.54, page: 2 },
  { name: 'material_conductor',x: 518,   y: 687.54, page: 2 },
  { name: 'ubicacio_comptadors',x: 430,  y: 670.98, page: 2 },
  { name: 'resist_conductors', x: 282,   y: 670.98, page: 2 },
  { name: 'aillament_terra',   x: 286.7, y: 653.94, page: 2 },
  { name: 'resist_terra',      x: 285.3, y: 636.90, page: 2 },
  { name: 'iga',               x: 284.7, y: 619.86, page: 2 },
  { name: 'opt_submin_si',     x: 225.7, y: 603.9, page: 2 },
  { name: 'opt_submin_no',     x: 259.7, y: 603.9, page: 2 },
