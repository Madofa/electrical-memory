...
const P1 = {
  ...
  empresa_nif:        { x: 488,   y: 532.7 },
  instalador_nom:     { x: 90.7,  y: 494   },
  instalador_cat:     { x: 374,   y: 494.7 },
  instalador_dni:     { x: 487.3, y: 494   },
  empresa_tipus_via:  { x: 90.8,  y: 456.2 },
  empresa_nom_via:    { x: 179.9, y: 456.2 },
  empresa_numero:     { x: 522.5, y: 457.1 },
  empresa_bloc:       { x: 90.8,  y: 418.1 },
  empresa_escala:     { x: 185.6, y: 418.1 },
  empresa_pis:        { x: 286.9, y: 418.1 },
  empresa_porta:      { x: 388.6, y: 418.1 },
  empresa_cp:         { x: 486.9, y: 415.1 },
  empresa_poblacio:   { x: 90.8,  y: 379.7 },
  empresa_tel:        { x: 318.2, y: 379.7 },
  empresa_correu:     { x: 404.4, y: 379.7 },
  inst_tipus_via:     { x: 90.8,  y: 307.4 },
  inst_nom_via:       { x: 179.9, y: 307.4 },
  ...
  inst_telefon:       { x: 318.2, y: 234   },
  inst_correu:        { x: 404.4, y: 234   },
  chk_nova:           { x: 90.1,  y: 173.8 },
  chk_ampliacio:      { x: 149.6, y: 173.8 },
  chk_modificacio:    { x: 224.7, y: 173.8 },
  cups:               { x: 386.7, y: 176.7 },
  opt_p1:             { x: 90.1,  y: 96.9  },
  opt_p2:             { x: 169.5, y: 96.9  },
  opt_memoria:        { x: 248.9, y: 96.9  },
...
const P2 = {
  ...
  calibre_cgp:         { x: 465.3, y: 721.86 },
  tensio:              { x: 137.3, y: 704.82 },
  iga_igm:             { x: 522,   y: 704.82 },
  num_circuits:        { x: 244,   y: 688.02 },
  seccio_lga:          { x: 390,   y: 687.54 },
  material_conductor:  { x: 518,   y: 687.54 },
  ubicacio_comptadors: { x: 430,   y: 670.98 },
  resist_conductors:   { x: 282,   y: 670.98 },
  aillament_terra:     { x: 286.7, y: 653.94 },
  resist_terra:        { x: 285.3, y: 636.90 },
  iga:                 { x: 284.7, y: 619.86 },
